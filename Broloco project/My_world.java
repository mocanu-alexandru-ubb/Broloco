 ...
 */
public class My_world extends Template
{
    public My_world(soundplayer nsfx)
    {    
        set_sfx(nsfx, 0);
        prepare();
    }
    ...
    { 
        ...
        int[] row6 = {0, 0, 0, 0, 0,42, 0, 0, 0, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0, 0};
        ...
        String[] afl = {
            "Mum",
            "John, are you planning on playing ROkemon   all day, today aswell?",
            "You should know how this game's controls     work, right?",
            "Press E to interact.",
            "Press Enter to advance text in a dialogue or to select an option.",
            "Press the arrow keys to move.",
            "I am fed up with your lazy butt. It is time for you to go out and earn your worth!",
            "And I got just the perfect task for you.    We actually run out of a very important item  ...",
            "... bread ...",
            "Why don't you go out and buy some bread...",
            "NOW!!!"
        };
        get_player().set_state("talking");
        get_txt().set_dia(afl);
    }
}
